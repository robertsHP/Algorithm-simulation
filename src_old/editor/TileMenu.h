...
namespace RawEngine {
    class TileMenu : public Obj
    {
        public:
            TileMenu(EditorDataRef editData, EngineDataRef eData);
            ~TileMenu() {printf("Kill TileMenu\n");}
            void init ();
        ...
        private:
            ...
            sf::Vector2u leftSize;
            sf::Vector2u menuSize;
            sf::Vector2u rightSize;
            sf::Vector2u selSize;
    };
}
